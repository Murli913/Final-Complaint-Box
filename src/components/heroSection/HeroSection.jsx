      ...
      <div className="mx-auto flex items-center justify-center flex-col">
        ...
        <main>
          <div className="text-center">
            ...
            >
              <img
                src="https://www.shutterstock.com/image-photo/children-violence-abused-concept-stop-600nw-2199536599.jpg"
                alt="image 1"
              ...
              />
              <img
                src="https://images.cnbctv18.com/wp-content/uploads/2021/02/sexual-harassment-1000x573.jpg?im=FitAndFill,width=1200,height=900"
                alt="image 4"
                className="h-full w-full object-cover"
              />
            </Carousel>
